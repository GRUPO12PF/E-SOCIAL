      ...
      >
        {({ errors }) => (
          <Form ref={form} action="">
            ...
            <div>
              <Field type="text" name="colection" id="colection" />
              <ErrorMessage
                name="colection"
                component={() => <p>{errors.colection}</p>}
              />
            </div>
            ...
            <div>
              ...
              <ErrorMessage
                name="description"
                component={() => <p>{errors.description}</p>}
              />
            </div>
            <label htmlFor="">Image</label>
            <div>
              <Field type="text" name="image" id="image" as="textarea" />
              <ErrorMessage
                name="image"
                component={() => <p>{errors.image}</p>}
              />
            </div>
            <label htmlFor="">Ranking</label>
            <div>
              <Field type="range" name="ranking" id="ranking" />
              <ErrorMessage
                name="ranking"
                component={() => <p>{errors.ranking}</p>}
              />
            </div>
